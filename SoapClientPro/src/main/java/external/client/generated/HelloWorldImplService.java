 ...
 * 
 */
@WebServiceClient(name = "HelloWorldImplService", targetNamespace = "http://test.com/", wsdlLocation = "http://localhost:8080/soapserver_war/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDIMPLSERVICE_QNAME = new QName("http://test.com/", "HelloWorldImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/soapserver_war/hello?wsdl");
    ...
    public HelloWorld getHelloWorldImplPort() {
        return super.getPort(new QName("http://test.com/", "HelloWorldImplPort"), HelloWorld.class);
    }
    ...
    public HelloWorld getHelloWorldImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://test.com/", "HelloWorldImplPort"), HelloWorld.class, features);
    }
