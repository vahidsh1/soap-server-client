...
public class ObjectFactory {
    ...
    private final static QName _SayHelloWorld_QNAME = new QName("http://test.com/", "sayHelloWorld");
    private final static QName _SayHelloWorldResponse_QNAME = new QName("http://test.com/", "sayHelloWorldResponse");
     ...
     */
    @XmlElementDecl(namespace = "http://test.com/", name = "sayHelloWorld")
     ...
     */
    @XmlElementDecl(namespace = "http://test.com/", name = "sayHelloWorldResponse")
